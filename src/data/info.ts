export const info = {
  ...
  experience: [
    {
      ...
      description: [
        ...
        "- Maintained and updated existing mobile applications, incorporating new features and improvements based on user feedback.",
        "- Ensured code quality and best practices by following coding standards, conducting code reviews, and implementing version control systems."
      ],
    },
  ...
  education: [
    {
      name: "Informatics Engineering, State University of Malang",
      location: "Malang, Indonesia",
      startDate: "2021",
      endDate: "2025",
      description: [],
  ...
  socialMedia: {
    github: "https://github.com/r-G7D",
    email: "danangrahmatbachtiar@gmail.com",
    linkedin: "https://www.linkedin.com/in/danang-rahmat-bachtiar/",
  },
  ...
  projects: [
    {
      ...
      isFeatured: true,
      thumbnail: "/astro-portfolio/public/assets/images/asslink.png",
      liveUrl: "https://play.google.com/store/apps/details?id=com.unesa.assessmentlink",
    },
    {
      title: "Gamifikasi Kosakata Metode Penelitian",
      isFeatured: true,
      thumbnail: "/astro-portfolio/public//assets/images/gami.png",
    },
    {
      title: "Ailment Alleviate",
      isFeatured: true,
      thumbnail: "/astro-portfolio/public/assets/images/ailment.png",
      githubUrl: "https://github.com/r-G7D/ailment_alleviate",
    },
    {
      title: "Astro Summarizer",
      isFeatured: true,
      thumbnail: "/astro-portfolio/public/assets/images/astro-summarizer.png",
    ...
    },
    {
      ...
      isFeatured: false,
      thumbnail: "/astro-portfolio/public/assets/images/astro-portfolio.png",
